...
class Dog extends Animal {
  // This is an act of 'polymorphism' as speak() of Dog class overrides speak() of its superclass(Animal).
  speak() {
    console.log("Woof!");
  }
}
...
class Cat extends Animal {
    // This is an act of 'polymorphism' as speak() of Cat class overrides speak() of its superclass(Animal).
  speak() {
    console.log("Meow!");
  }
}
...
// When you call animals.speak() on each animal, the appropriate implementation for that specific animal is executed. This demonstrates polymorphism, as the same method call can result in different behavior depending on the actual type of the object.
...
// The diamond problem occurs in object-oriented programming when a class inherits from two classes that have a common superclass. This creates a diamond-shaped hierarchy, where the subclass inherits the same methods or properties from both superclasses.
// Has-a relationship:
// A "has-a" relationship indicates that an object contains or owns another object.
// This relationship is often implemented using composition, where one object is composed of other objects.
// For example, a Car object might "have-a" Engine object, a Wheel object, and a SteeringWheel object.
class Engine {
  start() {
