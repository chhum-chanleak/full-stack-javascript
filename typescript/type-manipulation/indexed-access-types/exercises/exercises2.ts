...
// Exercise 1:
// Given the following 'Employee_2' interface, define a type EmployeeNameType that refers to the 'name' property.
...
// Exercise 2:
// Create a type UserContactInfo from the 'User_2' interface that combines the types of 'email' and 'phoneNumber'.
interface User_2 {
  id: number;
  email: string;
  phoneNumber: string;
...
type ProductPrice_2 = Producut_2["details"]["price"];  // ProductPrice will be `number`
...
// Exercise 4:
// Create a type 'KeysAndValues_2' that combines all the possible keys and values of the 'Gadget_2' interface.
interface Gadget_2 {
  brand: string;
  price: number;
  inStock: boolean;
