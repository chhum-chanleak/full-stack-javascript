...
const dates = JSON.parse(meeting, reviver);
...
const convertToJSON = (obj) => JSON.stringify(obj);
...
const filterSensitiveData = (obj) => JSON.stringify(obj, replacer2);
const adminsWithNoSensitiveData = filterSensitiveData(admins);

// console.log(admins);
// console.log(adminsWithNoSensitiveData);
...
const formatPersonData = (personObj) => JSON.stringify(personObj, null, 2);
const personData = formatPersonData(user2);
