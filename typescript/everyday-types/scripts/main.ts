...
// function sanitizeInut(str: string): UserInputSanitizedString  {
//   return sanitize(str);
// }

// // Create a sanitized input
// let userInput = sanitizeInut(getInput());
...
// has a literal type("Hello, world!") representation.
...
function configuration(x: Options | "auto") {
  // ...
}
// configure({ width: 100 });
// configure("auto");
